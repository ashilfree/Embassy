...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\Admin\\DashboardController'] = $instance = new \App\Controller\Admin\DashboardController(($container->privates['App\\Repository\\BookingRepository'] ?? $container->load('getBookingRepositoryService')), ($container->privates['App\\Repository\\SchedulerRepository'] ?? $container->load('getSchedulerRepositoryService')), ($container->privates['App\\Repository\\PopupRepository'] ?? $container->load('getPopupRepositoryService')), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ($container->privates['App\\Repository\\VisitStatsRepository'] ?? $container->getVisitStatsRepositoryService()), ($container->privates['App\\Repository\\ConnectedRepository'] ?? $container->load('getConnectedRepositoryService')));
