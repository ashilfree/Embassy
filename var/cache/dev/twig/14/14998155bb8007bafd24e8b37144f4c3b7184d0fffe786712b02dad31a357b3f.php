...
/* images.html.twig */
class __TwigTemplate_a314c50cef01ebd5546653c5d1b7c51de430536f65cf1ee774b28e6636c7f398 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"form-control\">
            {% for image in value %}
                <a href=\"#\" class=\"easyadmin-thumbnail\" data-featherlight=\"#easyadmin-lightbox-{{ item.id }}\" data-featherlight-close-on-click=\"anywhere\">
                    <img src=\"/uploads/files/{{ image.image }}\">
                </a>
...
{% endif %}", "images.html.twig", "/home/ubuntu/Projects/SymfonyProjects/Embassy/templates/images.html.twig");
    }
}
