...
class getDashboardControllerService extends App_KernelProdContainer
{
    ...
    {
        $container->services['App\\Controller\\Admin\\DashboardController'] = $instance = new \App\Controller\Admin\DashboardController(($container->privates['App\\Repository\\BookingRepository'] ?? $container->load('getBookingRepositoryService')), ($container->privates['App\\Repository\\SchedulerRepository'] ?? $container->load('getSchedulerRepositoryService')), ($container->privates['App\\Repository\\PopupRepository'] ?? $container->load('getPopupRepositoryService')), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()));
