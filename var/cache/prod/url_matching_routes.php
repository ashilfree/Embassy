...
return [
    ...
    [ // $dynamicRoutes
        41 => [[['_route' => 'check.schedule.backend', '_controller' => 'App\\Controller\\Admin\\SchedulerCrudController::check'], ['date'], null, null, false, true, null]],
        68 => [[['_route' => 'booking_show', '_controller' => 'App\\Controller\\BookingController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        80 => [[['_route' => 'booking_edit', '_controller' => 'App\\Controller\\BookingController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        87 => [[['_route' => 'booking_delete', '_controller' => 'App\\Controller\\BookingController::delete'], ['id'], ['DELETE' => 0], null, false, true, null]],
        130 => [[['_route' => 'article', '_controller' => 'App\\Controller\\HomeController::article'], ['slug', 'id'], null, null, false, true, null]],
        169 => [[['_route' => 'article.en', '_controller' => 'App\\Controller\\HomeControllerEn::article'], ['slug', 'id'], null, null, false, true, null]],
        203 => [[['_route' => 'article.fr', '_controller' => 'App\\Controller\\HomeControllerFr::article'], ['slug', 'id'], null, null, false, true, null]],
        242 => [[['_route' => 'page', '_controller' => 'App\\Controller\\HomeController::page'], ['id', 'class'], null, null, false, true, null]],
        278 => [[['_route' => 'page.en', '_controller' => 'App\\Controller\\HomeControllerEn::page'], ['id', 'class'], null, null, false, true, null]],
        309 => [[['_route' => 'page.fr', '_controller' => 'App\\Controller\\HomeControllerFr::page'], ['id', 'class'], null, null, false, true, null]],
        360 => [[['_route' => 'ef_connect', '_controller' => 'FM\\ElfinderBundle\\Controller\\ElFinderController::load', 'instance' => 'default', 'homeFolder' => ''], ['instance', 'homeFolder'], null, null, false, true, null]],
        403 => [[['_route' => 'elfinder', '_controller' => 'FM\\ElfinderBundle\\Controller\\ElFinderController::show', 'instance' => 'default', 'homeFolder' => ''], ['instance', 'homeFolder'], null, null, false, true, null]],
        466 => [[['_route' => 'liip_imagine_filter_runtime', '_controller' => 'Liip\\ImagineBundle\\Controller\\ImagineController::filterRuntimeAction'], ['filter', 'hash', 'path'], ['GET' => 0], null, false, true, null]],
        492 => [
